...
class Arithematic
{
    ...
    public void Addition(int A, double B) //changing sequance of argument of data type
    {
        System.out.println("Inside first Addition");
    }
    public void Addition(double A, int B) ////changing sequance of argument of data type
    {
